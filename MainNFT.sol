...
contract MainNFT is ERC721A, Ownable {
    ...
    address private signer = 0xDA419a4950ba574de9Cc5c24E03B145b5D68632C;
    ...
    function setDependecies(address _pool) external onlyOwner{
        stakingPool = StakingPool(_pool);
    }
    ...
    // 
    if (_msgSender() != address(stakingPool)){
